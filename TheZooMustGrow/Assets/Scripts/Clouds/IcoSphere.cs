...
namespace TheZooMustGrow
{
    public static class IcoSphere
    {
        ...
        public static GameObject Create(Material material, float radius = 1f)
        {
            ...
            MeshRenderer icoSphere_mr = icoSphere_go.AddComponent<MeshRenderer>();
            icoSphere_mr.material = material;

            mesh.Clear();
            Vector3[] vertices = icoSphere_go.GetComponent<MeshFilter>().mesh.vertices;
